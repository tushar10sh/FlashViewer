...
The test suite contains 171 Catch2 tests covering geo-transforms, settings,
...
plot is open, Persist across scopes, deleting one curve, closing a window discarding its plots, a selected batch profiling unsynced panes together, what Persist builds in each panel and keeps on screen,
